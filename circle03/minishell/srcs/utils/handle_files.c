...
/*   Updated: 2023/05/19 17:07:17 by zdevove          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @param node The command node where the outfile field is updated 
/// descriptor of the output file.
/// @param append_flag A flag that specifies whether to append to the file (1) 
/// or overwrite it (0).
/// @return 1 if the output redirection was successful,
...
/// @param filename The name of the file of the redirected input.
/// @param node The command node where the infile field is 
/// updated with the file descriptor of the input file.
/// @return 1 if the input redirection was successful, 
/// or 0 if an error occurred.
...
/// @return 1 if the redirection handling was successful, 
/// or 0 if an error occurred.
